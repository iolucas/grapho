...
async.waterfall([
    ...
    function(callback) {
        ...
        childArticlesObjs.forEach(function(childArtObj) {
            childArtObj.mainLinkCitations = countArrayIntersection(childArtObj.links, mainArticleObj.redirectUrls);
            childArtObj.citedByMainLink = countArrayIntersection(mainArticleObj.links, childArtObj.redirectUrls);      
        }, this);
...
getArticleAbstractLinks(mainArticleTitle, lang, function(error, links) {
    ...
    //Get the types of each abstract child link
    dbpediaApi.getArticlesTypes(links, lang, function(error, data) {
